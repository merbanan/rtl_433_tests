...
`codes_test.json`. No alarm/battery/heartbeat state variation was ever
captured, so only the raw 24 bit code is decoded; there's no evidence for
any further sub-field.
